      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex flex-col items-center mb-14">
          ...
          <p className="text-center px-4 mb-6">
            ...
            is the co-founder of Stactica, a software consulting company
            specializing in complete enterprise software and IT solutions. Ryan
            has a passion for technology, engineering, muy thai, security, and
            online privacy.
          </p>
          <a
            href="https://www.linkedin.com/in/rjlafazan/"
